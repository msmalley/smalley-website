...
def generate_all():
    ...
    pages = [
        ...
        # Section pages
        ('workflow.png', 'violet', 'Augmented Engineering',
         'Augmented Workflows', 'AI-augmented engineering at startup speed'),
        ...
        ('thoughts-16-days.png', 'violet', 'Thoughts',
         '16 Days, One Ecosystem', '70 chess variants and infinite hex maps'),
